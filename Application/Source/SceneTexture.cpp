...
void SceneTexture::Init()
{
	...
	meshList[GEO_SB_TOP] = MeshBuilder::GenerateQuad("Skybox Top", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_TOP]->textureID = LoadTGA("Image//top.tga");
	meshList[GEO_SB_BOTTOM] = MeshBuilder::GenerateQuad("Skybox Bottom", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_BOTTOM]->textureID = LoadTGA("Image//bottom.tga");
	meshList[GEO_SB_LEFT] = MeshBuilder::GenerateQuad("Skybox Left", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_LEFT]->textureID = LoadTGA("Image//left.tga");
	meshList[GEO_SB_RIGHT] = MeshBuilder::GenerateQuad("Skybox Right", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_RIGHT]->textureID = LoadTGA("Image//right.tga");
	meshList[GEO_SB_FRONT] = MeshBuilder::GenerateQuad("Skybox Front", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_FRONT]->textureID = LoadTGA("Image//front.tga");
	meshList[GEO_SB_BACK] = MeshBuilder::GenerateQuad("Skybox Back", glm::vec3(1.f, 1.f, 1.f), 1.f);
	meshList[GEO_SB_BACK]->textureID = LoadTGA("Image//back.tga");
...
void SceneTexture::Render()
{
	...
	// Skybox
	{
		// Top
		{
			PushPop skyboxTopGuard(modelStack);
			modelStack.Translate(0.f, 25.f, 0.f);
			modelStack.Rotate(90.f, 1.f, 0.f, 0.f);
			modelStack.Rotate(90.f, 0.f, 0.f, 1.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_TOP], false);
		}
		// Bottom
		{
			PushPop skyboxBottomGuard(modelStack);
			modelStack.Translate(0.f, -25.f, 0.f);
			modelStack.Rotate(-90.f, 1.f, 0.f, 0.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_BOTTOM], false);
		}
		// Left
		{
			PushPop skyboxLeftGuard(modelStack);
			modelStack.Translate(-25.f, 0.f, 0.f);
			modelStack.Rotate(90.f, 0.f, 1.f, 0.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_LEFT], false);
		}
		// Right
		{
			PushPop skyboxRightGuard(modelStack);
			modelStack.Translate(25.f, 0.f, 0.f);
			modelStack.Rotate(-90.f, 0.f, 1.f, 0.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_RIGHT], false);
		}
		// Front
		{
			PushPop skyboxFrontGuard(modelStack);
			modelStack.Translate(0.f, 0.f, -25.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_FRONT], false);
		}
		// Back
		{
			PushPop skyboxBackGuard(modelStack);
			modelStack.Translate(0.f, 0.f, 25.f);
			modelStack.Rotate(180.f, 0.f, 1.f, 0.f);
			modelStack.Scale(50.f, 50.f, 50.f);
			RenderMesh(meshList[GEO_SB_BACK], false);
		}
		// End of skybox
	}
	{
